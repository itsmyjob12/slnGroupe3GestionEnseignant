...
namespace Groupe3GestionEnseignant.Controllers
{
    public class ClassesController : Controller
    {
        ...
        public ClassesController(Groupe3GestionEnseingnantDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdClasse,Nom,Designation,Matricule")] Classe classe)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdClasse,Nom,Designation,Matricule")] Classe classe)
        {
